...
<form action="c03_PassengerTrain.php" method="get" enctype="application/x-www-form-urlencoded">
    <p><input type="text" name="distance"
              value="<?php if (!empty($_GET['distance'])) echo $_GET['distance']; else echo 0 ?>"/> Distance (in miles)
    </p>
    <p><input type="text" name="stops" value="<?php if (!empty($_GET['stops'])) echo $_GET['stops']; else echo 0 ?>"/>
        Number of Stops</p>
